...
prismplot<-function(y_title,y_val,p_v_lab,labels,plt_title, psiz=25){
  ...
  data_set=xlsx::read.xlsx2("./Figure 1/Fig1H_S4E_Datapoints_TableS7.xlsx",sheetName = plt_title)
...
pdf("./Figures_print/Fig1H_S4E_FCM_Bxplt.pdf",width =4,height = )
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_IFIM",
           p_v_lab="p.signif", labels=c("CD\nuninflamed","CD\ninflamed"))
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_IFIM",
          p_v_lab="p_round", psiz=10, labels=c("CD\nuninflamed","CD\ninflamed"))

prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_Mono2_3_4",
          p_v_lab="p.signif", labels=c("CD\nuninflamed","CD\ninflamed"))
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_Mono2_3_4",
          p_v_lab="p_round", psiz=10, labels=c("CD\nuninflamed","CD\ninflamed"))

prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_Late_Mono",
          p_v_lab="p.signif", labels=c("CD\nuninflamed","CD\ninflamed"))
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_Late_Mono",
          p_v_lab="p_round", psiz=10, labels=c("CD\nuninflamed","CD\ninflamed"))

prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_IFN_Macro",
          p_v_lab="p.signif", labels=c("CD\nuninflamed","CD\ninflamed"))
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_IFN_Macro",
          p_v_lab="p_round", psiz=10, labels=c("CD\nuninflamed","CD\ninflamed"))

prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_Macs7_8",
          p_v_lab="p.signif", labels=c("CD\nuninflamed","CD\ninflamed"))
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_Macs7_8",
          p_v_lab="p_round", psiz=10, labels=c("CD\nuninflamed","CD\ninflamed"))

prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_FOLR2pos_Macro",
          p_v_lab="p.signif", labels=c("CD\nuninflamed","CD\ninflamed"))
prismplot(y_title="% of mo-macs",y_val="value",plt_title="FCM_FOLR2pos_Macro",
          p_v_lab="p_round", psiz=10, labels=c("CD\nuninflamed","CD\ninflamed"))
dev.off()
